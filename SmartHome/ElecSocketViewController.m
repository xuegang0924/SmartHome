...
@interface ElecSocketViewController ()
{
...
@implementation ElecSocketViewController
...
- (void)viewDidLoad
{
    ...
    UIImage *image = [UIImage imageNamed:@"ElecSocketView320x568.png"];
    ...
    UpBtn.frame = CGRectMake((r.size.width - 65*3)/4, 300, 80, 80);
    UpBtn.tag = 10001;
    ...
    [UpBtn setImage:[UIImage imageNamed:@"TurnONImage1.png"] forState:UIControlStateNormal];
    ...
    DownBtn.frame = CGRectMake((r.size.width - 65*3)/4*3 + 65*2, 300, 80, 80);
    DownBtn.tag = 10003;
    DownBtn.backgroundColor = [UIColor blackColor];
    DownBtn.adjustsImageWhenHighlighted = YES;
    [DownBtn setBackgroundImage:[UIImage imageNamed:@"TurnOFFImage1.png"] forState:UIControlStateNormal];
    [DownBtn setImage:[UIImage imageNamed:@"TurnOFFImage1.png"] forState:UIControlStateNormal];
